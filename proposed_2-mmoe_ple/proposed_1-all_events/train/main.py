...
delete_flags(flags.FLAGS, ["gin_config_file", "data_path", "ads_semantic_embd_path", "web_browsing_semantic_embd_path", "shopping_semantic_embd_path", "ads_pure_corpus_embd_path", "other_semantic_embd_path", "ckpt_path" "output_path", "mode"])
...
flags.DEFINE_string("other_semantic_embd_path", None, "Path to the precomputed embeddings for other domain (domain 4), this is only used for job mode")
...
def main(argv) -> None:  # pyre-ignore [2]
    ...
    other_semantic_embd_path = FLAGS.other_semantic_embd_path
